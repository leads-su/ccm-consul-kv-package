...
/**
 * Class DirectoryListKeysRequestModelTest
 * @package ConsulConfigManager\Consul\KeyValue\Test\Unit\UseCases\KeyValue\Directory
 */
class DirectoryListKeysRequestModelTest extends TestCase
{
    /**
     * @return void
     */
    public function testShouldPassIfValidDataReturnedFromGetRequestMethod(): void
    {
        ...
        $model = new DirectoryListKeysRequestModel($request, 'test/directory');
